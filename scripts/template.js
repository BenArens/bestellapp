...
function getTotalTemplate(){
    return `<div class="divider-cart"></div> <div class="total-price" >Summe: <span>${checkout[0].total.toFixed(2)}€</span><br>Versand: 5€ <br> <span class="total"> Gesamt: ${checkout[0].totalShipment}</span> </div>
